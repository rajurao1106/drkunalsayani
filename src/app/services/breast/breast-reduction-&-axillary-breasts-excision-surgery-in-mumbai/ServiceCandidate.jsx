      ...
      <div className="flex w-full max-w-[1200px]">
        ...
        <div className="flex flex-col w-full">
          ...
          <h2 className="text-4xl font-bold max-lg:text-3xl font-notoSans text-[#10217D] leading-tight mb-4">
            Why Choose Breast Reduction & Axillary Breasts Excision service :
          </h2>
          ...
          <ul className="space-y-3 text-gray-800">
            {[
              `Specialized expertise in breast contouring surgeries with a focus on both aesthetics and comfort
`,
              `Tailored surgical plans to relieve physical discomfort and achieve balanced, proportionate results
`,
              `Expertise in addressing axillary (side) breast tissue for a smoother, more refined underarm contour
`,
              `Use of advanced surgical methods to minimize visible scarring and preserve natural breast shape
`,
              `Comprehensive pre-surgery evaluation and clear guidance on expected outcomes
`,
              `Post-operative care focused on safe recovery, reduced swelling, and long-term satisfaction


`,
              `Proven results in enhancing both physical relief and self-confidence through body reshaping
`,
            ].map((item, index) => (
