      ...
      <div className="flex w-full max-w-[1200px]">
        ...
        <div className="flex flex-col w-full">
          ...
          <h2 className="text-4xl font-bold max-lg:text-3xl font-notoSans text-[#10217D] leading-tight mb-4">
            Why Choose Hair Loss Treatment with Kunal Sayani:
          </h2>
...
`,
              `High success rates and real patient transformations speak to the effectiveness of our treatments.`,
              `Treatments are safe, minimally invasive, and designed for a smooth recovery with minimal disruption to your routine.`,
              `We believe in clear communication, fair pricing, and ethical practices — no hidden costs or false promises.`,
            ].map((item, index) => (
