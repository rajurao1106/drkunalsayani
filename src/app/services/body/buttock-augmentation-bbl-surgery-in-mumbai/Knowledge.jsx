        ...
        <div className="flex w-full max-lg:flex-col-reverse gap-6  max-lg-items-center">
            ...
            <div>
              ...
              <ul className="list-disc ml-6 space-y-1 mb-4">
                ...
                <li><strong>Follow-ups:</strong> Attend all your scheduled follow-up appointments at our state-of-the-art surgical center in Andheri to allow Dr. Sayani to monitor your healing progress.</li>
              </ul>
