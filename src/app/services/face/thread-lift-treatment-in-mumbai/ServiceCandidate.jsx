      ...
      <div className="flex w-full max-w-[1200px]">
        ...
        <div className="flex flex-col w-full">
          ...
          <h2 className="text-4xl font-bold max-lg:text-3xl font-notoSans text-[#10217D] leading-tight mb-4">
            Why Choose Thread Lift Treatment with Kunal Sayani :
          </h2>
          ...
          <ul className="space-y-3 text-gray-800">
            {[
              `Expertise in non-surgical facial rejuvenation with a focus on precision and natural-looking results
`,
              `Advanced use of dissolvable threads for effective facial contouring and skin lifting
`,
              `Personalized treatment plans based on individual skin type, facial structure, and aesthetic goals
`,
              `Minimally invasive approach with quick procedure time and minimal downtime
`,
              `Use of high-quality, FDA-approved threads ensuring safety and long-term benefits
`,
              `Comfortable in-clinic experience with thorough pre- and post-treatment support

`,
              `Proven patient satisfaction with enhanced facial definition and youthful appearance
`,
            ].map((item, index) => (
